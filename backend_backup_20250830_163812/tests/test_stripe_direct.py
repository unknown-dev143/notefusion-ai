"""Direct tests for Stripe API calls."""
import pytest
from unittest.mock import patch, MagicMock

def test_stripe_checkout_direct():
    """Test Stripe Checkout API call directly."""
...
def test_stripe_portal_direct():
    """Test Stripe Billing Portal API call directly."""
