"""Tests for payment service with fixed metadata handling."""
import pytest
...
class TestPaymentServiceFixed:
    """Test cases for PaymentService with fixed metadata handling."""
