...
export const FeatureFlagExample: React.FC = () => {
  ...
  return (
    <Card title="Feature Flags" className={styles['card'] || ''} style={{ maxWidth: 600, margin: '20px auto' }}>
      <div className={styles['featureItem'] || ""} style={{ marginBottom: 16 }}>
        <Title level={5}>Dark Mode</Title>
        <div className={styles['featureToggle'] || ""} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      ...
      <div className={styles['footerText'] || ""} style={{ marginTop: 24, color: '#666' }}>
        <Text type="secondary">
