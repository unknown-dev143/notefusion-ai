...
export const BackupManager: React.FC = () => {
  return (
    <div className={styles.container || ""} style={{ maxWidth: 1000, margin: '0 auto', padding: '16px' }}>
      <Space direction="vertical" size="large" className={styles.tabsContainer || ""} style={{ width: '100%' }}>
