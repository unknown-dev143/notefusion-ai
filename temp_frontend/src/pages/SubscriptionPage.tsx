  ...
  const handleSubscribe = async (planId: string) => {
    ...
    try {
      ...
      if (planId === 'free') {
        ...
        setCurrentPlan('free');
        message.success('Successfully downgraded to Free plan');
        return;
      }
      ...
      {currentPlan && usage && (
        <Card className="usage-card">
          <div className="usage-header">
            ...
            <Text type="secondary">Your monthly usage</Text>
          </div>
          <div className="usage-container">
            <div className="usage-stats">
              <Text strong>{usage.used}</Text>
              <Text type="secondary"> of {usage.total} minutes used</Text>
            </div>
            ...
            >
              ...
              <div className="plan-header">
                ...
                <div className="plan-price-container">
                  ...
                  <Text type="secondary" className="plan-interval">/month</Text>
                </div>
                {plan.price === 0 && (
...
const SubscriptionPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchSubscription = async () => {
      try {
        // Try to fetch subscription data from the API
        const [subscriptionResponse, usageResponse] = await Promise.all([
          api.get('/subscription/current'),
          api.get('/subscription/usage')
        ]);
